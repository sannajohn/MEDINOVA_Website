    ...
    const {name, avgRating, totalRating, photo, specialization, totalPatients, hospital} = doctor;
        ...
        <div className='p-3 lg:p-5'>
            ...
            <div className="mt-2 lg:mt-4 flex items-center justify-between">
                ...
                <span className="flex items-center gap-[6px] text-[14px] leading-6 lg:text-[16px] lheading-7
            ...
            <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
                ...
                <Link to={`/doctors/${doctor._id}`} className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] 
